    ...
    initializeCustomSettings: function(component) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (country === 'Australia'){ 
                component.set('v.terms', customSettingValues.Warranty_Terms_and_Condition__c);
                component.set('v.privacy', customSettingValues.Privacy__c);
                component.set('v.termsofuse', customSettingValues.Term_of_Use__c);
            } else {
                component.set('v.terms', customSettingValues.Warranty_Terms_and_Condition_NZ__c);
                component.set('v.privacy', customSettingValues.Privacy_NZ__c);
                component.set('v.termsofuse', customSettingValues.Term_of_Use_NZ__c);
            }
        });
        $A.enqueueAction(action);
    },
