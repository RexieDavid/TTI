({
    ...
    handleHourIncrement: function(component, event, helper) {
        const childName = component.get("v.childName");
        ...
        let totalMinutes = component.get('v.record.timeTaken');
        console.log('child totalMins: ' + totalMinutes);
        let curHours = '0';
        let curMins = '0';
        let totalTime = '0';
        if (totalMinutes >= 0 && totalMinutes < 480) {
    ...
    handleIncrement: function(component, event, helper) {
        ...
        cmpEvent.fire();
        let isTimeIncrease = component.get("v.isTimeIncrease");
        console.log('isTimeInc: ' + isTimeIncrease);
        if (!isTimeIncrease) {
            return;
        }

        let totalMinutes = component.get('v.record.timeTaken');
        console.log('child timeTaken: ' + totalMinutes);
