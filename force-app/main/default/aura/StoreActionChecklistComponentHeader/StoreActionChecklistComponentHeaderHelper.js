({
    colourIconInit: function (component) {
        const minutes = component.get('v.record.TimeTaken__c');
        if ($A.util.isUndefinedOrNull(minutes)) {
            component.set('v.record.TimeTaken__c', 0);
